...
export default function HowToOrder() {
  const steps = [
    ...
    },
    {
      ...
      description:
        "Tap 'Order via WhatsApp' on any product or message us directly for personalized assistance.",
      icon: (
    ...
    },
    {
      ...
      description:
        "We’ll confirm your order, price, and delivery details promptly with care and devotion.",
      icon: (
        <svg
          className="w-10 h-10"
          fill="none"
    ...
    },
    {
      ...
      description:
        "Enjoy island-wide delivery with secure Cash on Delivery or bank transfer options.",
      icon: (
        <svg
          className="w-10 h-10"
          fill="none"
          ...
          <path
            ...
            strokeLinejoin="round"
            strokeWidth={2}
            d="M8 7V3a2 2 0 012-2h8a2 2 0 012 2v4m-12 0h12m-8 4h4m-8 4h8m-8-8h.01M7 20h10a2 2 0 002-2v-4"
          />
        </svg>
      ),
    },
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-accent/80 mt-4 max-w-2xl mx-auto leading-relaxed">
            Ordering from Grazie.lk is simple, transparent, and fully assisted
            via WhatsApp.
          </p>
        </div>
